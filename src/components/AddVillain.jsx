                ...
                <div className='modal-footer'>
                    <div className='container'>
                        <form>
                            ...
                            <div>
                                <label className="comics-label">
                                    Comics:
                                </label>
                                <input type="text" className="comics-text-box" onChange={(event) => props.setModalInfo({...props.modalInfo, comics: event.target.value})}></input>
                            </div>
                            <div>
